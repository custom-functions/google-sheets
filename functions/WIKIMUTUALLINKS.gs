...
function WIKIMUTUALLINKS(article, opt_namespaces) {
  'use strict';
  var inboundLinks = WIKIINBOUNDLINKS_(article, opt_namespaces);
  var outboundLinks = WIKIOUTBOUNDLINKS_(article, opt_namespaces);
...
function WIKIINBOUNDLINKS_(article, opt_namespaces) {
  'use strict';
  if (!article) {
    return '';
  }
...
function WIKIOUTBOUNDLINKS_(article, opt_namespaces) {
  'use strict';
  if (!article) {
    return '';
  }
